...
def get_average_travel_time():
    xtree = et.parse(r"C:\Users\91896\Desktop\ALL\Capstone\mappo\amman.tripinfo.xml")
    xroot = xtree.getroot()
...
def get_average_waiting_time_test_AI():
    xtree = et.parse(r"C:\Users\91896\Desktop\ALL\Capstone\mappo\test.tripinfo.xml")
    xroot = xtree.getroot()
...
def get_average_waiting_time_test():
    xtree = et.parse(r"C:\Users\91896\Desktop\ALL\Capstone\mappo\test_real.tripinfo.xml")
    xroot = xtree.getroot()
