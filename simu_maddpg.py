...
sys.path.append(r"C:\Users\91896\Desktop\ALL\Capstone\maddpg")
...
if __name__ == "__main__":
    ...
    results_dir = r"C:\Users\91896\Desktop\ALL\Capstone\maddpg\result"
   ...
   # bar_width = 0.5
    ...
    plt.figure(figsize=(10, 5))
    plt.plot(depart_times, fuel_cons, label='MADDPG', color='blue')
    plt.xlabel("DEPART (SEC)")
    ...
    plt.figure(figsize=(10, 5))
    plt.plot(depart_times, performance_list, label='MADDPG', color='blue')
    plt.xlabel("DEPART (SEC)")
...
np.save(os.path.join(results_dir, "maddpg_avg_travel_time.npy"), np.array(performance_list))